...
void RunAction::EndOfRunAction(const G4Run* run)
{
  ...
  if (generatorAction) {
    // Since we're using G4GeneralParticleSource, we cannot use GetParticleGun()
    // Instead, we'll just print a generic message or skip this part
    runCondition = "gamma (via GeneralParticleSource)";
  }
